...
export default function AppDownloadCard() {
    return (
        <div className="relative bg-white rounded-2xl shadow-md p-8 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto overflow-hidden translate-y-9 ">
            {/* Left curved line */}
            <div className="absolute top-0 left-10 w-24 h-24 border-t-2 border-l-2 border-orange-300 rounded-bl-full"></div>

            {/* Right semicircle background */}
            <div className="absolute bottom-0 right-0 w-48 h-48 bg-red-100 rounded-tl-full"></div>
